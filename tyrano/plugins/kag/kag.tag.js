...
mouseoversound=マウスオーバー時に鳴るサウンドを設定できます。
#[end]
*/
...
tyrano.plugin.kag.tag.link={
    ...
    start:function(pm){
        ...
        (function(){
            ...
            if (pm.mouseoversound !== "") {
                j_span.mouseover(function() {
                    that.kag.ftag.startTag("playse",{
                        storage:pm.mouseoversound,
                        target:"se",
                        loop:"false",
                        clear:"false"
                    });
...
mouseoversound=マウスオーバー時に鳴る音を指定できます
